...
from coppafish.call_spots import background
...
def test_fit_background():
    ...
    residual1, coef1, background_vectors1 = background.fit_background(spot_colours, weight_shift=0)
    ...
    residual1, coef1, background_vectors1 = background.fit_background(spot_colours, weight_shift=0)
    residual2, coef2, background_vectors2 = background.fit_background(spot_colours, weight_shift=10)
