...
def thresh_box_plots(nb: Notebook):
    ...
    """
    box_data = [nb.filter.auto_thresh[nb.basic_info.use_tiles, r, c] for c in nb.basic_info.use_channels for r in nb.basic_info.use_rounds]
    if nb.basic_info.use_anchor:
        box_data = box_data + [nb.filter.auto_thresh[nb.basic_info.use_tiles, nb.basic_info.anchor_round, nb.basic_info.anchor_channel]]
